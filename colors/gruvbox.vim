...
let s:gb.bright_green   = ['#71bb26', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#f1d12f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#839aa5', 109]     " 131-165-152
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#7cc0b5', 108]     " 142-192-124
let s:gb.bright_orange  = ['#fe8019', 208]     " 254-128-25

let s:gb.neutral_red    = ['#cc241d', 124]     " 204-36-29
let s:gb.neutral_green  = ['#59981a', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#d7b921', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#457288', 66]      " 69-133-136
let s:gb.neutral_purple = ['#b16286', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#689d94', 72]      " 104-157-106
let s:gb.neutral_orange = ['#d65d0e', 166]     " 214-93-14

let s:gb.faded_red      = ['#9d0006', 88]      " 157-0-6
let s:gb.faded_green    = ['#44790e', 100]     " 121-116-14
let s:gb.faded_yellow   = ['#b59a14', 136]     " 181-118-20
let s:gb.faded_blue     = ['#075278', 24]      " 7-102-120
let s:gb.faded_purple   = ['#8f3f71', 96]      " 143-63-113
let s:gb.faded_aqua     = ['#427b71', 66]      " 66-123-88
